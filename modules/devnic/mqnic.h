...
/* v2.1.1: kernel-based HDS*/
/* v2.1.2: experiment rx flow steering; rename to devnic*/
/* v2.2.0: userspace backed HDS, i.e., zero-copy*/
#define DRIVER_NAME "devnic"
...
struct mqnic_ring {
    ...
    union {
        ...
        struct mqnic_rx_info* rx_info;// each rx_info is associated with an element of 'buf'
    };
