...
module fpga #(
  ...
  sync_signal #(
      ...
      .clk(pcie_user_clk),
      .in ({qsfp0_modprsl, qsfp1_modprsl, qsfp0_intl, qsfp1_intl, i2c_scl, i2c_sda}),
      .out({qsfp_modprsl_int, qsfp_intl_int, i2c_scl_i, i2c_sda_i})
  );
  ...
  BUFG pcie_user_reset_bufg_inst (
  ...
  // Ethernet
  localparam QSFP_CNT = 1;  //Manually set to 1
