...
***************************************************************************************************/
import axi4stream_vip_pkg::*;
import design_1_axi4stream_vip_0_0::*;
import design_1_axi4stream_vip_1_0::*;
//import ex_sim_axi4stream_vip_passthrough_0_pkg::*;
  ...
  ***************************************************************************************************/
  ...
  initial begin
    ...
    ***************************************************************************************************/
    ...
    mst_agent = new("master vip agent",DUT.axi4stream_vip_0.inst.IF);
    slv_agent = new("slave vip agent",DUT.axi4stream_vip_1.inst.IF);
